...
export const getBalanceParameters = {
  type: 'object',
  properties: {
    address: { type: 'string', description: 'Wallet address to get balance for' },
  },
  required: ['address'],
};

export const getLatestBlockParameters = { type: 'object', properties: {} };

export const getTransactionsByAddressParameters = {
  type: 'object',
  properties: {
    address: { type: 'string', description: 'Cronos address to get transactions for' },
    session: { type: 'string', description: 'Previous page session. Leave empty for first page' },
    limit: { type: 'number', description: 'Page size (max 100)', minimum: 1, maximum: 100, default: 20 },
  },
  required: ['address'],
};
...
export const getContractAbiParameters = {
  type: 'object',
  properties: {
    address: { type: 'string', description: 'Contract address to get ABI for' },
  },
  required: ['address'],
};
...
export const getTransactionByHash = {
  type: 'object',
  properties: {
    txHash: { type: 'string', description: 'Transaction hash to get details for' },
  },
  required: ['txHash'],
};
...
export const getTransactionStatusParameters = {
  type: 'object',
  properties: {
    txHash: { type: 'string', description: 'Transaction hash to get status for' },
  },
  required: ['txHash'],
};

export const createWalletParameters = { type: 'object', properties: {} };

export const wrapTokenParameters = {
  type: 'object',
  properties: {
    amount: { type: 'number', description: 'Amount of native token to be wrapped' },
  },
  required: ['amount'],
};
...
export const SwapTokenParameters = {
  type: 'object',
  properties: {
    amount: { type: 'number', description: 'Amount of token to be swapped' },
    fromContractAddress: {
      type: 'string',
...
export const getCurrentTimeParameters = { type: 'object', properties: {} };
